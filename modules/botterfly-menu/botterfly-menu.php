...
class BotterFly_Menu_Module extends FLBuilderModule {
    ...
    public function __construct() {
        parent::__construct( array(
            ...
            'dir' => botterfly_custom_bb_modules_PATH . 'modules/botterfly-menu/',
            'url' => botterfly_custom_bb_modules_URL . 'modules/botterfly-menu/',
...
FLBuilder::register_module( 'BotterFly_Menu_Module', array() );
