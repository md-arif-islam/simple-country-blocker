...
class BotterFly_AiArtPage_Module extends FLBuilderModule {
    ...
    public function __construct() {
        parent::__construct( array(
            ...
            'url' => botterfly_custom_bb_modules_URL . 'modules/ai-art-page/',
...
FLBuilder::register_module( 'BotterFly_AiArtPage_Module', array() );
